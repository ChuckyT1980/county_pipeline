# Pre-Auction Property Intelligence Dossier: 071-150-003-000

**County**: Butte County, CA  
**Source Identifier**: `071-150-003-000` (APN (from source list))  
**Assessor APN**: `071-150-003-000`  
...
| **Estimated Equity Ratio** | **87.3%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $3,602.00 |
| **Net Assessed Total Value** | $28,443.00 |
...
- **Owner of Record**: **ROJAS LUIS A**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  CRAIG ACCESS RD  FEATHER FALLS
...
- **Open Encumbrance Count**: 36 recorded instruments
