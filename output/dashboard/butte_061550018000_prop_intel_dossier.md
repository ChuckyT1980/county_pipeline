# Pre-Auction Property Intelligence Dossier: 061-550-018-000

**County**: Butte County, CA  
**Source Identifier**: `061-550-018-000` (APN (from source list))  
**Assessor APN**: `061-550-018-000`  
...
| **Estimated Equity Ratio** | **89.5%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $5,805.00 |
| **Net Assessed Total Value** | $55,159.00 |
...
- **Owner of Record**: **YANG YER**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  HE LE VE RD  BERRY CREEK
