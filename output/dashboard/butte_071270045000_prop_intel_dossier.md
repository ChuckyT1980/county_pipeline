# Pre-Auction Property Intelligence Dossier: 071-270-045-000

**County**: Butte County, CA  
**Source Identifier**: `071-270-045-000` (APN (from source list))  
**Assessor APN**: `071-270-045-000`  
...
| **Estimated Equity Ratio** | **84.1%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $6,814.00 |
| **Net Assessed Total Value** | $42,964.00 |
...
- **Owner of Record**: **DOWNING LORIN**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  CRYSTAL RANCH RD  FEATHER FALLS
