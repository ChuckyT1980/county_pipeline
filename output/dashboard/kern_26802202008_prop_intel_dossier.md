# Pre-Auction Property Intelligence Dossier: 268-022-02-00-8

**County**: Kern County, CA  
**Source Identifier**: `268-022-02-00-8` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `268-022-02`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('26802202.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $1,900.00 |
...
- **Last Recorded Doc Number**: `226069188` (Recorded: 06/17/2026)
