# Pre-Auction Property Intelligence Dossier: 052-080-054-000

**County**: Butte County, CA  
**Source Identifier**: `052-080-054-000` (APN (from source list))  
**Assessor APN**: `052-080-054-000`  
...
| **Estimated Equity Ratio** | **75.7%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $6,070.00 |
...
- **Owner of Record**: **BIRTWELL LESLIE**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 5960  MCCLAIN LN  PARADISE
...
- **Open Encumbrance Count**: 28 recorded instruments
