# Pre-Auction Property Intelligence Dossier: 055-330-017-000

**County**: Butte County, CA  
**Source Identifier**: `055-330-017-000` (APN (from source list))  
**Assessor APN**: `055-330-017-000`  
...
| **Estimated Equity Ratio** | **56.8%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $12,960.00 |
...
- **Owner of Record**: **WEATHERS DAVID O**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 1963  HILLPARK LN  PARADISE
...
- **Open Encumbrance Count**: 21 recorded instruments
