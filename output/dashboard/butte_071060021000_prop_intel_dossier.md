# Pre-Auction Property Intelligence Dossier: 071-060-021-000

**County**: Butte County, CA  
**Source Identifier**: `071-060-021-000` (APN (from source list))  
**Assessor APN**: `071-060-021-000`  
...
| **Estimated Equity Ratio** | **47.4%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $5,247.00 |
| **Net Assessed Total Value** | $9,983.00 |
...
- **Owner of Record**: **WELDON, DONALD & DONNA**
...
- **Data Integrity Status**: PARTIALLY VERIFIED — owner_name_confidence=0.92, verification_score=50
