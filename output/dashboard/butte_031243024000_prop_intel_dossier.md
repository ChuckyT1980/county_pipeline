# Pre-Auction Property Intelligence Dossier: 031-243-024-000

**County**: Butte County, CA  
**Source Identifier**: `031-243-024-000` (APN (from source list))  
**Assessor APN**: `031-243-024-000`  
...
| **Estimated Equity Ratio** | **49.1%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $14,043.00 |
| **Net Assessed Total Value** | $27,586.00 |
...
- **Owner of Record**: **MESSA KRISTINE**
...
- **Data Integrity Status**: PARTIALLY VERIFIED — owner_name_confidence=0.90, verification_score=62
- **Data Gap Audit**: Missing: doc_number, situs, transfer_tax, acreage, buyer_match
