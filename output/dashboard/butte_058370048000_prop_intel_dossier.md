# Pre-Auction Property Intelligence Dossier: 058-370-048-000

**County**: Butte County, CA  
**Source Identifier**: `058-370-048-000` (APN (from source list))  
**Assessor APN**: `058-370-048-000`  
...
| **Estimated Equity Ratio** | **73.4%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $2,664.00 |
...
- **Owner of Record**: **GREGG DON E**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 13264  AMBLESIDE DR  CONCOW
...
- **Open Encumbrance Count**: 24 recorded instruments
