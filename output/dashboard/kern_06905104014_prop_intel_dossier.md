# Pre-Auction Property Intelligence Dossier: 069-051-04-01-4

**County**: Kern County, CA  
**Source Identifier**: `069-051-04-01-4` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `069-051-04`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('6905104.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
- **Owner of Record**: **SAUCEDO ERIKA PRIETO**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 21316 BADGER ST LOST HILLS
...
- **Last Recorded Doc Number**: `220018260` (Recorded: 02/10/2020)
...
- **Primary Source Endpoint**: `assessorapps.kerncounty.com (live, verified 2026-08-06/07) + recorderonline.co.kern.ca.us document-number search (live, verified 2026-08-08, doc #220018260)`
- **Data Integrity Status**: VERIFIED — BOTH SITES (assessed value/tax-default status and recorder document/owner only - the assessor parcel number itself is NOT independently verified, see Assessor APN Verification Status above). Assessed value and tax-default status confirmed live against the county assessor. Owner of record confirmed via the recorder's document-number search on the exact recorded document (Deed - Quitclaim, 02/10/2020) already captured for this specific parcel — tied to this parcel's ATN-identified record, not a name-only match.
