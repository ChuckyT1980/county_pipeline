# Pre-Auction Property Intelligence Dossier: 059-087-011-000

**County**: Butte County, CA  
**Source Identifier**: `059-087-011-000` (APN (from source list))  
**Assessor APN**: `059-087-011-000`  
...
**Generated Date**: 2026-08-08 12:06:47  
...
| **Estimated Equity Ratio** | **43.0%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $10,539.00 |
| **Net Assessed Total Value** | $18,486.00 |
...
- **Owner of Record**: **SIMMONS LINDA S**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 7843  GYPSUM ST  STIRLING CITY
...
- **Open Encumbrance Count**: 19 recorded instruments
