# Pre-Auction Property Intelligence Dossier: 071-270-029-000

**County**: Butte County, CA  
**Source Identifier**: `071-270-029-000` (APN (from source list))  
**Assessor APN**: `071-270-029-000`  
...
|---|---|
| **Opportunity Tier** | **Level 1 (Prime Opportunity — Top 5%)** |
| **Seller Intent Score** | **80.0 / 100** |
| **Estimated Equity Ratio** | **61.0%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $21,731.00 |
| **Net Assessed Total Value** | $55,774.00 |
...
- **Owner of Record**: **SEJ PROPERTIES LLC**
...
- **Primary Source Endpoint**: `butte/butte_SCORED_AUCTION_MATCHES_CALL_SHEET.csv`
- **Data Integrity Status**: PARTIALLY VERIFIED — owner_name_confidence=0.90, verification_score=62
- **Data Gap Audit**: Missing: doc_number, situs, doc_count, transfer_tax, acreage, buyer_match
