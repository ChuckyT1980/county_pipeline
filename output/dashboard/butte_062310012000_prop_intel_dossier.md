# Pre-Auction Property Intelligence Dossier: 062-310-012-000

**County**: Butte County, CA  
**Source Identifier**: `062-310-012-000` (APN (from source list))  
**Assessor APN**: `062-310-012-000`  
...
**Generated Date**: 2026-08-08 12:06:49  
...
| **Estimated Equity Ratio** | **46.5%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $7,594.00 |
| **Net Assessed Total Value** | $14,207.00 |
...
- **Owner of Record**: **ENGKVIST KRISTI SUE EXECUTOR**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  CEDAR CIR  BERRY CREEK
...
- **Last Recorded Doc Number**: `N/A` (Recorded: N/A)
- **Documentary Transfer Tax**: $N/A *(Calculated Transfer Consideration: $N/A)*
- **Open Encumbrance Count**: 8 recorded instruments
...
- **Data Integrity Status**: PARTIALLY VERIFIED — owner_name_confidence=0.90, verification_score=100
- **Data Gap Audit**: Missing: doc_number, transfer_tax, acreage, buyer_match
