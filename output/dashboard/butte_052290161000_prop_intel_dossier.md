# Pre-Auction Property Intelligence Dossier: 052-290-161-000

**County**: Butte County, CA  
**Source Identifier**: `052-290-161-000` (APN (from source list))  
**Assessor APN**: `052-290-161-000`  
...
| **Estimated Equity Ratio** | **80.9%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $2,127.00 |
| **Net Assessed Total Value** | $11,153.00 |
...
- **Owner of Record**: **MASON MARY L**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 504  MONTGOMERY PL  PARADISE
