# Pre-Auction Property Intelligence Dossier: 307-063-16-00-2

**County**: Kern County, CA  
**Source Identifier**: `307-063-16-00-2` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `307-063-16`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('30706316.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $2,188.00 |
...
- **Owner of Record**: **VELASCO MARTIN**
...
- **Last Recorded Doc Number**: `199072371` (Recorded: 05/20/1999)
...
- **Primary Source Endpoint**: `assessorapps.kerncounty.com (live, verified 2026-08-06/07) + recorderonline.co.kern.ca.us document-number search (live, verified 2026-08-08, doc #199072371)`
- **Data Integrity Status**: VERIFIED — BOTH SITES (assessed value/tax-default status and recorder document/owner only - the assessor parcel number itself is NOT independently verified, see Assessor APN Verification Status above). Assessed value and tax-default status confirmed live against the county assessor. Owner of record confirmed via the recorder's document-number search on the exact recorded document (Deed, 05/20/1999) already captured for this specific parcel — tied to this parcel's ATN-identified record, not a name-only match. NOTE: this corrects a stale name from the original source list ("VELASCO MARTIN & JUANITA JESSICA") — the property has a more recent recorded transfer to "VELASCO MARTIN" that the source list predates.
