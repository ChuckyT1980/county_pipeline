# Pre-Auction Property Intelligence Dossier: 006-130-019-000
...
| **Lien Risk Tier** | **LOW** |
| **Minimum Starting Bid** | $62,424.75 |
| **Net Assessed Total Value** | $249,699.00 |
...
- **Owner of Record**: **COWAN NEAL W**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 18235 ENCINO DR 18235 ENCINO DR COTTONWOOD CA 96022
- **Land Use Code**: Standard Real Property
- **Acreage / Lot Size**: 5.00 acres
...
- **Last Recorded Doc Number**: `2015R009588` (Recorded: N/A)
...
- **Primary Source Endpoint**: `apps.mptsweb.com/TaxBillv2 (live, verified 2026-08-06, default case DEF260000032) + data/counties/tehama/pre_auction_intel.csv (owner name)`
- **Data Integrity Status**: PARTIALLY VERIFIED — assessed value and current default status (case DEF260000032, defaulted 06/30/2026) confirmed live against the county tax bill; owner name from local list, not independently recorder-cross-referenced (Tehama's recorder requires solving a Google reCAPTCHA that no free automated method could pass tonight)
