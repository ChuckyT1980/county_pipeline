# Pre-Auction Property Intelligence Dossier: 228-162-22-01-4

**County**: Kern County, CA  
**Source Identifier**: `228-162-22-01-4` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `228-162-22`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('22816222.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $500.00 |
...
- **Owner of Record**: **ABUNDIS GUILLERMO**
...
- **Last Recorded Doc Number**: `200017485` (Recorded: 02/14/2000)
