# Pre-Auction Property Intelligence Dossier: 219-082-05-00-7

**County**: Kern County, CA  
**Source Identifier**: `219-082-05-00-7` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `219-082-05`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('21908205.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $4,200.00 |
...
- **Owner of Record**: **MORIN MICHAEL C**
...
- **Last Recorded Doc Number**: `226086078` (Recorded: 07/28/2026)
