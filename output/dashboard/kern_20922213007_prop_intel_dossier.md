# Pre-Auction Property Intelligence Dossier: 209-222-13-00-7

**County**: Kern County, CA  
**Source Identifier**: `209-222-13-00-7` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `209-222-13`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('20922213.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
- **Owner of Record**: **VALENTINE RENEE L**
...
- **Last Recorded Doc Number**: `207077616` (Recorded: 04/10/2007)
