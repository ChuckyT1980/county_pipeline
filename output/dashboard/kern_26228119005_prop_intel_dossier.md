# Pre-Auction Property Intelligence Dossier: 262-281-19-00-5

**County**: Kern County, CA  
**Source Identifier**: `262-281-19-00-5` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `262-281-19`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('26228119.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
- **Last Recorded Doc Number**: `226068201` (Recorded: 06/15/2026)
