# Pre-Auction Property Intelligence Dossier: 294-233-04-00-3

**County**: Kern County, CA  
**Source Identifier**: `294-233-04-00-3` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `294-233-04`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('29423304.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
- **Owner of Record**: **BOLLAND DUANE E**
...
- **Last Recorded Doc Number**: `205085100` (Recorded: 04/05/2005)
