# Pre-Auction Property Intelligence Dossier: 035-191-010-000

**County**: Butte County, CA  
**Source Identifier**: `035-191-010-000` (APN (from source list))  
**Assessor APN**: `035-191-010-000`  
...
| **Estimated Equity Ratio** | **48.4%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $8,007.00 |
| **Net Assessed Total Value** | $15,532.00 |
...
- **Owner of Record**: **ILLMAN, CHRISTINE ESTATE**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 2476 ORO BANGOR HWY, OROVILLE
...
- **Data Integrity Status**: PARTIALLY VERIFIED — owner_name_confidence=0.92, verification_score=88
- **Data Gap Audit**: Missing: doc_number, doc_count, transfer_tax, acreage, buyer_match
