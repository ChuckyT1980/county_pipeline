# Pre-Auction Property Intelligence Dossier: 058-260-060-000

**County**: Butte County, CA  
**Source Identifier**: `058-260-060-000` (APN (from source list))  
**Assessor APN**: `058-260-060-000`  
...
**Generated Date**: 2026-08-08 12:06:46  
...
| **Estimated Equity Ratio** | **42.7%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $24,226.00 |
| **Net Assessed Total Value** | $42,309.00 |
...
- **Owner of Record**: **DUNCAN SUNJA**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 11228  DAWN TERRACE DR  CONCOW
...
- **Open Encumbrance Count**: 52 recorded instruments
...
- **Data Integrity Status**: PARTIALLY VERIFIED — owner_name_confidence=0.90, verification_score=75
