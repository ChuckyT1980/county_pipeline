# Pre-Auction Property Intelligence Dossier: 001-081-007-000

**County**: Butte County, CA  
**Source Identifier**: `001-081-007-000` (APN (from source list))  
**Assessor APN**: `001-081-007-000`  
...
| **Estimated Equity Ratio** | **31.8%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $8,239.00 |
| **Net Assessed Total Value** | $12,072.00 |
...
- **Owner of Record**: **DEWSNUP KYLE THOMAS**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 483  B ST  BIGGS
