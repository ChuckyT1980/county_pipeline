# Pre-Auction Property Intelligence Dossier: 046-070-12-00-0

**County**: Kern County, CA  
**Source Identifier**: `046-070-12-00-0` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `046-070-12`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('4607012.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Minimum Starting Bid** | $94,500.00 |
| **Net Assessed Total Value** | $33,140.00 |
...
- **Owner of Record**: **GARMEDEXPRESS LLC**
...
- **Last Recorded Doc Number**: `226083840` (Recorded: 07/22/2026)
