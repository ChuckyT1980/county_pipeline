# Pre-Auction Property Intelligence Dossier: 041-260-027-000

**County**: Butte County, CA  
**Source Identifier**: `041-260-027-000` (APN (from source list))  
**Assessor APN**: `041-260-027-000`  
...
| **Estimated Equity Ratio** | **93.9%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $10,149.00 |
| **Net Assessed Total Value** | $165,484.00 |
...
- **Owner of Record**: **YADIRA PROPERTIES LLC**
- **Owner Entity Type**: Corporate Entity / Trust
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 266  YADIRA LN  OROVILLE
