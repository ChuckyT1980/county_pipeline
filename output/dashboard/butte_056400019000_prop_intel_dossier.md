# Pre-Auction Property Intelligence Dossier: 056-400-019-000

**County**: Butte County, CA  
**Source Identifier**: `056-400-019-000` (APN (from source list))  
**Assessor APN**: `056-400-019-000`  
...
| **Estimated Equity Ratio** | **60.1%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $5,260.00 |
| **Net Assessed Total Value** | $13,185.00 |
...
- **Owner of Record**: **BARTON, ROY E JR & MARY I**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 8710 COHASSET RD, COHASSET
...
- **Data Integrity Status**: PARTIALLY VERIFIED — owner_name_confidence=0.95, verification_score=88
