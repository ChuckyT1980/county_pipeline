# Pre-Auction Property Intelligence Dossier: 052-040-067-000

**County**: Butte County, CA  
**Source Identifier**: `052-040-067-000` (APN (from source list))  
**Assessor APN**: `052-040-067-000`  
...
| **Estimated Equity Ratio** | **63.0%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $12,933.00 |
...
- **Owner of Record**: **STORMER SCOTT THOMAS**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 694  BROOKHAVEN   PARADISE
