# Pre-Auction Property Intelligence Dossier: 062-730-008-000

**County**: Butte County, CA  
**Source Identifier**: `062-730-008-000` (APN (from source list))  
**Assessor APN**: `062-730-008-000`  
...
| **Estimated Equity Ratio** | **42.5%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $11,240.00 |
| **Net Assessed Total Value** | $19,535.00 |
...
- **Owner of Record**: **SULLIVAN ARLENE**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 16  MENZIE LN  BERRY CREEK
...
- **Open Encumbrance Count**: 0 recorded instruments
