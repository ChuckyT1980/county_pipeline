# Pre-Auction Property Intelligence Dossier: 035-098-011-000

**County**: Butte County, CA  
**Source Identifier**: `035-098-011-000` (APN (from source list))  
**Assessor APN**: `035-098-011-000`  
...
| **Estimated Equity Ratio** | **35.8%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $25,017.00 |
| **Net Assessed Total Value** | $38,976.00 |
...
- **Owner of Record**: **WHITFIELD, SARAH**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 3333 COLUMBIA AVE, OROVILLE
