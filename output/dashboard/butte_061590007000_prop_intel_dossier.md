# Pre-Auction Property Intelligence Dossier: 061-590-007-000

**County**: Butte County, CA  
**Source Identifier**: `061-590-007-000` (APN (from source list))  
**Assessor APN**: `061-590-007-000`  
...
| **Estimated Equity Ratio** | **65.3%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $7,534.00 |
| **Net Assessed Total Value** | $21,740.00 |
...
- **Owner of Record**: **BROOKS RALPH**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  BUCKBOARD WAY  BERRY CREEK
...
- **Open Encumbrance Count**: 20 recorded instruments
