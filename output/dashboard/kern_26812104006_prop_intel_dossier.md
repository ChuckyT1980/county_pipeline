# Pre-Auction Property Intelligence Dossier: 268-121-04-00-6

**County**: Kern County, CA  
**Source Identifier**: `268-121-04-00-6` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `268-121-04`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('26812104.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
- **Last Recorded Doc Number**: `226074616` (Recorded: 06/30/2026)
