# Pre-Auction Property Intelligence Dossier: 228-321-31-00-0

**County**: Kern County, CA  
**Source Identifier**: `228-321-31-00-0` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `228-321-31`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('22832131.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
- **Last Recorded Doc Number**: `226068306` (Recorded: 06/15/2026)
