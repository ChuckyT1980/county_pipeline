# Pre-Auction Property Intelligence Dossier: 058-370-027-000

**County**: Butte County, CA  
**Source Identifier**: `058-370-027-000` (APN (from source list))  
**Assessor APN**: `058-370-027-000`  
...
| **Estimated Equity Ratio** | **13.1%** |
| **Equity / Assessed-Value Indicator** | **LOW** |
| **Minimum Starting Bid** | $8,691.00 |
...
- **Owner of Record**: **RODRIGUEZ VALERIE ANN**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 3827  CAMELOT LN  CONCOW
