# Pre-Auction Property Intelligence Dossier: 035-073-020-000

**County**: Butte County, CA  
**Source Identifier**: `035-073-020-000` (APN (from source list))  
**Assessor APN**: `035-073-020-000`  
...
- **Owner of Record**: **SEFIC ISMET**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 1920  B ST  OROVILLE
...
- **Open Encumbrance Count**: 18 recorded instruments
