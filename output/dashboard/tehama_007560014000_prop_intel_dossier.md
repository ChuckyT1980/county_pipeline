# Pre-Auction Property Intelligence Dossier: 007-560-014-000
...
| **Lien Risk Tier** | **LOW** |
| **Minimum Starting Bid** | $64,733.25 |
| **Net Assessed Total Value** | $258,933.00 |
...
- **Owner of Record**: **BEDNAR BRIAN**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 18350 INDIAN CAMP RD 18350 INDIAN CAMP RD COTTONWOOD CA 96022
- **Land Use Code**: Standard Real Property
- **Acreage / Lot Size**: 11.94 acres
...
- **Last Recorded Doc Number**: `2026R002140` (Recorded: N/A)
...
- **Primary Source Endpoint**: `apps.mptsweb.com/TaxBillv2 (live, verified 2026-08-06, default case DEF260000111) + data/counties/tehama/pre_auction_intel.csv (owner name)`
- **Data Integrity Status**: PARTIALLY VERIFIED — assessed value and current default status (case DEF260000111, defaulted 06/30/2026) confirmed live against the county tax bill; owner name from local list, not independently recorder-cross-referenced (Tehama's recorder requires solving a Google reCAPTCHA that no free automated method could pass tonight)
