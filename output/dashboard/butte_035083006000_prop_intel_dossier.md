# Pre-Auction Property Intelligence Dossier: 035-083-006-000

**County**: Butte County, CA  
**Source Identifier**: `035-083-006-000` (APN (from source list))  
**Assessor APN**: `035-083-006-000`  
...
| **Estimated Equity Ratio** | **67.3%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $7,235.00 |
| **Net Assessed Total Value** | $22,146.00 |
...
- **Owner of Record**: **TACKET BONNIE F**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 2327  A ST  OROVILLE
