# Pre-Auction Property Intelligence Dossier: 066-050-011-000

**County**: Butte County, CA  
**Source Identifier**: `066-050-011-000` (APN (from source list))  
**Assessor APN**: `066-050-011-000`  
...
| **Estimated Equity Ratio** | **17.0%** |
| **Equity / Assessed-Value Indicator** | **LOW** |
| **Minimum Starting Bid** | $9,961.00 |
...
- **Owner of Record**: **SORENSEN BONNIE**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 6498  SHAW CIR  MAGALIA
