# Pre-Auction Property Intelligence Dossier: 275-161-01-00-1

**County**: Kern County, CA  
**Source Identifier**: `275-161-01-00-1` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `275-161-01`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('27516101.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
- **Last Recorded Doc Number**: `226069212` (Recorded: 06/17/2026)
