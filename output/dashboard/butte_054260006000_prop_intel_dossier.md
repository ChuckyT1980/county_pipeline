# Pre-Auction Property Intelligence Dossier: 054-260-006-000

**County**: Butte County, CA  
**Source Identifier**: `054-260-006-000` (APN (from source list))  
**Assessor APN**: `054-260-006-000`  
...
| **Estimated Equity Ratio** | **9.2%** |
| **Equity / Assessed-Value Indicator** | **LOW** |
| **Minimum Starting Bid** | $22,707.00 |
...
- **Owner of Record**: **BROWN SUSAN**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 1791  DRENDEL CIR  PARADISE
