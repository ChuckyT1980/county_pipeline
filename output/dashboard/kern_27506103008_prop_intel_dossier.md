# Pre-Auction Property Intelligence Dossier: 275-061-03-00-8

**County**: Kern County, CA  
**Source Identifier**: `275-061-03-00-8` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `275-061-03`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('27506103.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $1,700.00 |
...
- **Last Recorded Doc Number**: `226069187` (Recorded: 06/17/2026)
