# Pre-Auction Property Intelligence Dossier: 006-160-005-000
...
| **Lien Risk Tier** | **LOW** |
| **Minimum Starting Bid** | $10,277.00 |
| **Net Assessed Total Value** | $41,108.00 |
...
- **Owner of Record**: **ALL PERSONS**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 18610 CYPRESS DR 18610 CYPRESS DR COTTONWOOD CA 96022
- **Land Use Code**: Standard Real Property
- **Acreage / Lot Size**: 10.05 acres
...
- **Last Recorded Doc Number**: `2025R011221` (Recorded: N/A)
...
- **Primary Source Endpoint**: `apps.mptsweb.com/TaxBillv2 (live, verified 2026-08-06, default case DEF230000035) + data/counties/tehama/pre_auction_intel.csv (owner name)`
- **Data Integrity Status**: PARTIALLY VERIFIED — assessed value and current default status (case DEF230000035, defaulted 06/30/2023) confirmed live against the county tax bill; owner name from local list, not independently recorder-cross-referenced (Tehama's recorder requires solving a Google reCAPTCHA that no free automated method could pass tonight)
