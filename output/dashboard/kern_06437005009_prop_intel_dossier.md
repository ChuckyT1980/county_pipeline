# Pre-Auction Property Intelligence Dossier: 064-370-05-00-9

**County**: Kern County, CA  
**Source Identifier**: `064-370-05-00-9` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `064-370-05`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('6437005.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
