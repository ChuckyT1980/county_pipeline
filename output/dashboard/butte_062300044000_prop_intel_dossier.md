# Pre-Auction Property Intelligence Dossier: 062-300-044-000

**County**: Butte County, CA  
**Source Identifier**: `062-300-044-000` (APN (from source list))  
**Assessor APN**: `062-300-044-000`  
...
| **Estimated Equity Ratio** | **51.1%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $11,588.00 |
| **Net Assessed Total Value** | $23,690.00 |
...
- **Owner of Record**: **PATON DANIEL**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: MEADOW LANE DR  BERRY CREEK
...
- **Open Encumbrance Count**: 12 recorded instruments
