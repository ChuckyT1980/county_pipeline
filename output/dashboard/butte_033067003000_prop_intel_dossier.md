# Pre-Auction Property Intelligence Dossier: 033-067-003-000

**County**: Butte County, CA  
**Source Identifier**: `033-067-003-000` (APN (from source list))  
**Assessor APN**: `033-067-003-000`  
...
- **Owner of Record**: **OWENS JIMMIE R**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 260  FERNWOOD AVE  OROVILLE
...
- **Data Gap Audit**: Missing: assessed_value, doc_number, transfer_tax, acreage, buyer_match
