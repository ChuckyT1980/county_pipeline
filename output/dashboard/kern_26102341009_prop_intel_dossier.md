# Pre-Auction Property Intelligence Dossier: 261-023-41-00-9

**County**: Kern County, CA  
**Source Identifier**: `261-023-41-00-9` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `261-023-41`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('26102341.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
- **Owner of Record**: **SCHAUL SHANNON K**
...
- **Last Recorded Doc Number**: `209054385` (Recorded: 04/17/2009)
