# Pre-Auction Property Intelligence Dossier: 062-340-018-000

**County**: Butte County, CA  
**Source Identifier**: `062-340-018-000` (APN (from source list))  
**Assessor APN**: `062-340-018-000`  
...
| **Estimated Equity Ratio** | **63.4%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $12,990.00 |
| **Net Assessed Total Value** | $35,533.00 |
...
- **Owner of Record**: **TOUPES MICHAEL**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  SUGAR PINE DR  BERRY CREEK
...
- **Open Encumbrance Count**: 30 recorded instruments
