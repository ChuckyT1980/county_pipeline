# Pre-Auction Property Intelligence Dossier: 275-202-01-00-9

**County**: Kern County, CA  
**Source Identifier**: `275-202-01-00-9` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `275-202-01`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('27520201.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $1,800.00 |
...
- **Owner of Record**: **JACKSON LAMONICA**
...
- **Last Recorded Doc Number**: `226079403` (Recorded: 07/10/2026)
