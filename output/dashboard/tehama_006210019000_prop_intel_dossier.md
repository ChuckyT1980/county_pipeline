# Pre-Auction Property Intelligence Dossier: 006-210-019-000
...
| **Lien Risk Tier** | **LOW** |
| **Minimum Starting Bid** | $21,004.50 |
| **Net Assessed Total Value** | $84,018.00 |
...
- **Owner of Record**: **CAMAREN MARK A**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 18910 FAIR OAKS DR 18910 FAIR OAKS DR COTTONWOOD CA 96022
- **Land Use Code**: Standard Real Property
- **Acreage / Lot Size**: 2.50 acres
- **Tax Delinquency Status**: N/A — not confirmed in source data (Defaulted: 2020)

---

## 📄 Recorder & Encumbrance Provenance

- **Last Recorded Doc Number**: `2019R005034` (Recorded: N/A)
...
- **Primary Source Endpoint**: `apps.mptsweb.com/TaxBillv2 (live, verified 2026-08-06, default case DEF200000043) + data/counties/tehama/pre_auction_intel.csv (owner name)`
- **Data Integrity Status**: PARTIALLY VERIFIED — assessed value and current default status (case DEF200000043, defaulted 06/30/2020) confirmed live against the county tax bill; owner name from local list, not independently recorder-cross-referenced (Tehama's recorder requires solving a Google reCAPTCHA that no free automated method could pass tonight)
