# Pre-Auction Property Intelligence Dossier: 001-081-018-000

**County**: Butte County, CA  
**Source Identifier**: `001-081-018-000` (APN (from source list))  
**Assessor APN**: `001-081-018-000`  
...
| **Estimated Equity Ratio** | **14.6%** |
| **Equity / Assessed-Value Indicator** | **LOW** |
| **Minimum Starting Bid** | $22,221.00 |
| **Net Assessed Total Value** | $26,024.00 |
...
- **Owner of Record**: **HONAN GARY**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 499  B ST  BIGGS
