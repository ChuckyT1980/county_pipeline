# Pre-Auction Property Intelligence Dossier: 051-072-071-000

**County**: Butte County, CA  
**Source Identifier**: `051-072-071-000` (APN (from source list))  
**Assessor APN**: `051-072-071-000`  
...
| **Estimated Equity Ratio** | **83.9%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $6,436.00 |
...
- **Owner of Record**: **SILVERSTEIN ARTHUR**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 6336  AUGUST LN  PARADISE
