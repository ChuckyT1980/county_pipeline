# Pre-Auction Property Intelligence Dossier: 050-120-121-000

**County**: Butte County, CA  
**Source Identifier**: `050-120-121-000` (APN (from source list))  
**Assessor APN**: `050-120-121-000`  
...
| **Estimated Equity Ratio** | **84.6%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $5,392.00 |
...
- **Owner of Record**: **MORRIS RONALD**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 1871  DEAN RD  PARADISE
...
- **Open Encumbrance Count**: 81 recorded instruments
