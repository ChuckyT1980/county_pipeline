# Pre-Auction Property Intelligence Dossier: 071-280-038-000

**County**: Butte County, CA  
**Source Identifier**: `071-280-038-000` (APN (from source list))  
**Assessor APN**: `071-280-038-000`  
...
| **Estimated Equity Ratio** | **78.7%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $14,991.00 |
| **Net Assessed Total Value** | $70,376.00 |
...
- **Owner of Record**: **MEYERS WAYNE E JR**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  COCHISE DR  FEATHER FALLS
