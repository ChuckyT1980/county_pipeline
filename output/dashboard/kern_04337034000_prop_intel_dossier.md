# Pre-Auction Property Intelligence Dossier: 043-370-34-00-0

**County**: Kern County, CA  
**Source Identifier**: `043-370-34-00-0` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `043-370-34`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('4337034.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Estimated Equity Ratio** | **62.8%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $1,400.00 |
| **Net Assessed Total Value** | $3,761.00 |
...
- **Last Recorded Doc Number**: `226076961` (Recorded: 07/06/2026)
