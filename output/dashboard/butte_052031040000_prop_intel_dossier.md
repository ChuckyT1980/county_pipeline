# Pre-Auction Property Intelligence Dossier: 052-031-040-000

**County**: Butte County, CA  
**Source Identifier**: `052-031-040-000` (APN (from source list))  
**Assessor APN**: `052-031-040-000`  
...
| **Estimated Equity Ratio** | **75.3%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $9,871.00 |
...
- **Owner of Record**: **PEREZ KISIA Y**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 499  VALLEY VIEW DR  PARADISE
...
- **Open Encumbrance Count**: 7 recorded instruments
