# Pre-Auction Property Intelligence Dossier: 058-370-023-000

**County**: Butte County, CA  
**Source Identifier**: `058-370-023-000` (APN (from source list))  
**Assessor APN**: `058-370-023-000`  
...
| **Estimated Equity Ratio** | **84.7%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $3,556.00 |
| **Net Assessed Total Value** | $23,206.00 |
...
- **Owner of Record**: **COONS MANDY MARIE**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 3808  WINDERMERE LN  CONCOW
