# Pre-Auction Property Intelligence Dossier: 066-130-036-000

**County**: Butte County, CA  
**Source Identifier**: `066-130-036-000` (APN (from source list))  
**Assessor APN**: `066-130-036-000`  
...
| **Estimated Equity Ratio** | **37.1%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $7,549.00 |
...
- **Owner of Record**: **CONWAY DONNA L**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 13778 W PARK DR  MAGALIA
...
- **Open Encumbrance Count**: 34 recorded instruments
