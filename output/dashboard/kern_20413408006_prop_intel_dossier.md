# Pre-Auction Property Intelligence Dossier: 204-134-08-00-6

**County**: Kern County, CA  
**Source Identifier**: `204-134-08-00-6` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `204-134-08`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('20413408.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $4,171.00 |
...
- **Owner of Record**: **JASSO JOSE DANIEL GUZMAN**
...
- **Last Recorded Doc Number**: `226056026` (Recorded: 05/18/2026)
