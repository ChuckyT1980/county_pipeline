# Pre-Auction Property Intelligence Dossier: 278-181-31-00-5

**County**: Kern County, CA  
**Source Identifier**: `278-181-31-00-5` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `278-181-31`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('27818131.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Minimum Starting Bid** | $5,400.00 |
| **Net Assessed Total Value** | $2,956.00 |
...
- **Owner of Record**: **ANSON WARREN JOHN TR**
...
- **Last Recorded Doc Number**: `202186349` (Recorded: 11/05/2002)
...
- **Primary Source Endpoint**: `assessorapps.kerncounty.com (live, verified 2026-08-06/07) + recorderonline.co.kern.ca.us document-number search (live, verified 2026-08-08, doc #202186349)`
- **Data Integrity Status**: VERIFIED — BOTH SITES (assessed value/tax-default status and recorder document/owner only - the assessor parcel number itself is NOT independently verified, see Assessor APN Verification Status above). Assessed value and tax-default status confirmed live against the county assessor. Owner of record confirmed via the recorder's document-number search on the exact recorded document (Deed - Quitclaim, 11/05/2002) already captured for this specific parcel — tied to this parcel's ATN-identified record, not a name-only match. NOTE: this corrects a stale name from the original source list ("ANSON FAMILY TRUST") — the property has a more recent recorded transfer to "ANSON WARREN JOHN TR" that the source list predates.
