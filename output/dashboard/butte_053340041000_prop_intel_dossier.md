# Pre-Auction Property Intelligence Dossier: 053-340-041-000

**County**: Butte County, CA  
**Source Identifier**: `053-340-041-000` (APN (from source list))  
**Assessor APN**: `053-340-041-000`  
...
- **Owner of Record**: **BUCKER JEANIE**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 1719  EDEN ROC DR  PARADISE
