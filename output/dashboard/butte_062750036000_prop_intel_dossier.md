# Pre-Auction Property Intelligence Dossier: 062-750-036-000

**County**: Butte County, CA  
**Source Identifier**: `062-750-036-000` (APN (from source list))  
**Assessor APN**: `062-750-036-000`  
...
| **Estimated Equity Ratio** | **47.2%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $13,249.00 |
| **Net Assessed Total Value** | $25,114.00 |
...
- **Owner of Record**: **BYERS JO A**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 34  LEAF LN  BERRY CREEK
...
- **Open Encumbrance Count**: 32 recorded instruments
