# Pre-Auction Property Intelligence Dossier: 007-180-015-000
...
| **Lien Risk Tier** | **LOW** |
| **Minimum Starting Bid** | $32,069.50 |
| **Net Assessed Total Value** | $128,278.00 |
...
- **Owner of Record**: **CABRERA JUANITA ELIZET**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 16685 MATLOCK LOOP 1740 TULANE AVE EAST PALO ALTO CA 94303
- **Land Use Code**: Standard Real Property
- **Acreage / Lot Size**: 10.00 acres
- **Tax Delinquency Status**: N/A — not confirmed in source data (Defaulted: 2021)

---

## 📄 Recorder & Encumbrance Provenance

- **Last Recorded Doc Number**: `2020R004478` (Recorded: N/A)
...
- **Primary Source Endpoint**: `apps.mptsweb.com/TaxBillv2 (live, verified 2026-08-06, default case DEF210000066) + data/counties/tehama/pre_auction_intel.csv (owner name)`
- **Data Integrity Status**: PARTIALLY VERIFIED — assessed value and current default status (case DEF210000066, defaulted 06/30/2021) confirmed live against the county tax bill; owner name from local list, not independently recorder-cross-referenced (Tehama's recorder requires solving a Google reCAPTCHA that no free automated method could pass tonight)
