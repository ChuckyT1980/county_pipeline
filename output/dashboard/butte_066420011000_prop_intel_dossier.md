# Pre-Auction Property Intelligence Dossier: 066-420-011-000

**County**: Butte County, CA  
**Source Identifier**: `066-420-011-000` (APN (from source list))  
**Assessor APN**: `066-420-011-000`  
...
| **Estimated Equity Ratio** | **52.0%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $5,762.00 |
...
- **Owner of Record**: **BATES REVOCABLE INT VIV TRUST ESTATE**
- **Owner Entity Type**: Corporate Entity / Trust
- **Out-of-State Owner**: No
- **Property Situs Address**: 6772 ISHI DR, MAGALIA
