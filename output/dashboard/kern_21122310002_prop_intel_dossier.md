# Pre-Auction Property Intelligence Dossier: 211-223-10-00-2

**County**: Kern County, CA  
**Source Identifier**: `211-223-10-00-2` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `211-223-10`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('21122310.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $2,942.00 |
...
- **Owner of Record**: **KENNEY DIANE M**
...
- **Last Recorded Doc Number**: `207253957` (Recorded: 12/28/2007)
...
- **Primary Source Endpoint**: `assessorapps.kerncounty.com (live, verified 2026-08-06/07) + recorderonline.co.kern.ca.us document-number search (live, verified 2026-08-08, doc #207253957)`
