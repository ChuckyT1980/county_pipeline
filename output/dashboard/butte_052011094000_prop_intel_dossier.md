# Pre-Auction Property Intelligence Dossier: 052-011-094-000

**County**: Butte County, CA  
**Source Identifier**: `052-011-094-000` (APN (from source list))  
**Assessor APN**: `052-011-094-000`  
...
| **Estimated Equity Ratio** | **47.5%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $5,561.00 |
| **Net Assessed Total Value** | $10,588.00 |
...
- **Owner of Record**: **BUCK DONALD GEORGE**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 6167  DUNCOMBE DR  PARADISE
...
- **Open Encumbrance Count**: 33 recorded instruments
