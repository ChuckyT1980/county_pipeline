# Pre-Auction Property Intelligence Dossier: 052-250-052-000

**County**: Butte County, CA  
**Source Identifier**: `052-250-052-000` (APN (from source list))  
**Assessor APN**: `052-250-052-000`  
...
| **Estimated Equity Ratio** | **75.2%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $8,679.00 |
...
- **Owner of Record**: **COLUNGA RICHARD**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 5612  SKYWAY   PARADISE
