# Pre-Auction Property Intelligence Dossier: 305-122-13-00-9

**County**: Kern County, CA  
**Source Identifier**: `305-122-13-00-9` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `305-122-13`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('30512213.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Minimum Starting Bid** | $4,000.00 |
| **Net Assessed Total Value** | $2,500.00 |
