# Pre-Auction Property Intelligence Dossier: 062-300-007-000

**County**: Butte County, CA  
**Source Identifier**: `062-300-007-000` (APN (from source list))  
**Assessor APN**: `062-300-007-000`  
...
| **Estimated Equity Ratio** | **6.4%** |
| **Equity / Assessed-Value Indicator** | **LOW** |
| **Minimum Starting Bid** | $5,993.00 |
| **Net Assessed Total Value** | $6,404.00 |
...
- **Owner of Record**: **MCDONNELL, DONALD C REV & MISSIONARY APOSTOLATE**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: LOT 11 AZALEA LANE, BERRY CREEK
...
- **Data Integrity Status**: PARTIALLY VERIFIED — owner_name_confidence=0.85, verification_score=62
