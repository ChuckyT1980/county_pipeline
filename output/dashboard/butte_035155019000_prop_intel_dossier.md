# Pre-Auction Property Intelligence Dossier: 035-155-019-000

**County**: Butte County, CA  
**Source Identifier**: `035-155-019-000` (APN (from source list))  
**Assessor APN**: `035-155-019-000`  
...
| **Estimated Equity Ratio** | **17.2%** |
| **Equity / Assessed-Value Indicator** | **LOW** |
| **Minimum Starting Bid** | $15,894.00 |
| **Net Assessed Total Value** | $19,206.00 |
...
- **Owner of Record**: **PURVIS JOHN**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 3727  MYERS ST  OROVILLE
