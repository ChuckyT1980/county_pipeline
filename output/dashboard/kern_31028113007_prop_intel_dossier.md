# Pre-Auction Property Intelligence Dossier: 310-281-13-00-7

**County**: Kern County, CA  
**Source Identifier**: `310-281-13-00-7` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `310-281-13`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('31028113.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $1,200.00 |
...
- **Last Recorded Doc Number**: `226054296` (Recorded: 05/13/2026)
