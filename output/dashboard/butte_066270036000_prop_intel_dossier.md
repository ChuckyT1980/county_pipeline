# Pre-Auction Property Intelligence Dossier: 066-270-036-000

**County**: Butte County, CA  
**Source Identifier**: `066-270-036-000` (APN (from source list))  
**Assessor APN**: `066-270-036-000`  
...
| **Estimated Equity Ratio** | **25.6%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $8,924.00 |
...
- **Owner of Record**: **RAZO-ORREGO ARIANA M**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 6229  PUEBLO DR  MAGALIA
...
- **Open Encumbrance Count**: 5 recorded instruments
