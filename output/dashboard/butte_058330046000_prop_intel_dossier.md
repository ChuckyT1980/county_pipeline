# Pre-Auction Property Intelligence Dossier: 058-330-046-000

**County**: Butte County, CA  
**Source Identifier**: `058-330-046-000` (APN (from source list))  
**Assessor APN**: `058-330-046-000`  
...
| **Estimated Equity Ratio** | **63.6%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $12,435.00 |
| **Net Assessed Total Value** | $34,133.00 |
...
- **Owner of Record**: **CRUMMY JEFFREY S**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 13310  MEADOW SPRINGS RD  CONCOW
