# Pre-Auction Property Intelligence Dossier: 062-320-006-000

**County**: Butte County, CA  
**Source Identifier**: `062-320-006-000` (APN (from source list))  
**Assessor APN**: `062-320-006-000`  
...
| **Estimated Equity Ratio** | **77.1%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $3,993.00 |
...
- **Owner of Record**: **BUTLER LAURENCE A**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  SAND CREEK DR  BERRY CREEK
...
- **Open Encumbrance Count**: 4 recorded instruments
