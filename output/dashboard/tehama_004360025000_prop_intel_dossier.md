# Pre-Auction Property Intelligence Dossier: 004-360-025-000
...
| **Lien Risk Tier** | **LOW** |
| **Minimum Starting Bid** | $51,235.50 |
| **Net Assessed Total Value** | $204,942.00 |
...
- **Owner of Record**: **BRAKEL LISA D**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 18480 BOWMAN RD 18480 BOWMAN RD COTTONWOOD CA 96022
- **Land Use Code**: Standard Real Property
- **Acreage / Lot Size**: 1.65 acres
...
- **Last Recorded Doc Number**: `2019R009273` (Recorded: N/A)
...
- **Primary Source Endpoint**: `apps.mptsweb.com/TaxBillv2 (live, verified 2026-08-06, default case DEF240000032) + data/counties/tehama/pre_auction_intel.csv (owner name)`
- **Data Integrity Status**: PARTIALLY VERIFIED — assessed value and current default status (case DEF240000032, defaulted 06/30/2024) confirmed live against the county tax bill; owner name from local list, not independently recorder-cross-referenced (Tehama's recorder requires solving a Google reCAPTCHA that no free automated method could pass tonight)
