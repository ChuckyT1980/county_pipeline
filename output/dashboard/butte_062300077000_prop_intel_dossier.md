# Pre-Auction Property Intelligence Dossier: 062-300-077-000

**County**: Butte County, CA  
**Source Identifier**: `062-300-077-000` (APN (from source list))  
**Assessor APN**: `062-300-077-000`  
...
| **Estimated Equity Ratio** | **40.1%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $31,497.00 |
| **Net Assessed Total Value** | $52,596.00 |
...
- **Owner of Record**: **JOHNSON MYRA**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  MEADOW LANE DR  BERRY CREEK
...
- **Open Encumbrance Count**: 3 recorded instruments
