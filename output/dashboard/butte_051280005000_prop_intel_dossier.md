# Pre-Auction Property Intelligence Dossier: 051-280-005-000

**County**: Butte County, CA  
**Source Identifier**: `051-280-005-000` (APN (from source list))  
**Assessor APN**: `051-280-005-000`  
...
| **Estimated Equity Ratio** | **72.0%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $9,787.00 |
...
- **Owner of Record**: **BUSH ROBERT D**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 6670  EVERGREEN LN  PARADISE
...
- **Open Encumbrance Count**: 56 recorded instruments
