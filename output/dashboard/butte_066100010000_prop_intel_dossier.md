# Pre-Auction Property Intelligence Dossier: 066-100-010-000

**County**: Butte County, CA  
**Source Identifier**: `066-100-010-000` (APN (from source list))  
**Assessor APN**: `066-100-010-000`  
...
| **Estimated Equity Ratio** | **27.8%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $8,668.00 |
...
- **Owner of Record**: **DAVIDOW TYLER**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 6350  GLENDALE DR  MAGALIA
...
- **Open Encumbrance Count**: 11 recorded instruments
