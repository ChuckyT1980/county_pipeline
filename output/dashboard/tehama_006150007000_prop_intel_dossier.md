# Pre-Auction Property Intelligence Dossier: 006-150-007-000
...
| **Lien Risk Tier** | **LOW** |
| **Minimum Starting Bid** | $81,250.00 |
| **Net Assessed Total Value** | $325,000.00 |
...
- **Owner of Record**: **LILLY ROBERT DAVID**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 18850 TURNELL RD 18850 TURNELL ROAD COTTONWOOD CA 96022
...
- **Last Recorded Doc Number**: `2025R007963` (Recorded: N/A)
...
- **Primary Source Endpoint**: `apps.mptsweb.com/TaxBillv2 (live, verified 2026-08-06, default case DEF260001217) + data/counties/tehama/pre_auction_intel.csv (owner name)`
- **Data Integrity Status**: PARTIALLY VERIFIED — assessed value and current default status (case DEF260001217, defaulted 06/30/2026) confirmed live against the county tax bill; owner name from local list, not independently recorder-cross-referenced (Tehama's recorder requires solving a Google reCAPTCHA that no free automated method could pass tonight)
