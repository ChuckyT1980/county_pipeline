# Pre-Auction Property Intelligence Dossier: 058-430-019-000

**County**: Butte County, CA  
**Source Identifier**: `058-430-019-000` (APN (from source list))  
**Assessor APN**: `058-430-019-000`  
...
|---|---|
| **Opportunity Tier** | **Level 1 (Prime Opportunity — Top 5%)** |
| **Seller Intent Score** | **90.0 / 100** |
| **Estimated Equity Ratio** | **62.4%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $7,242.00 |
| **Net Assessed Total Value** | $19,282.00 |
...
- **Owner of Record**: **SVENSSON, BERTIL F G ESTATE (+10 co-heirs)**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 0 WINDERMERE LN, CONCOW
