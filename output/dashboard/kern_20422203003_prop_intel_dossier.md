# Pre-Auction Property Intelligence Dossier: 204-222-03-00-3

**County**: Kern County, CA  
**Source Identifier**: `204-222-03-00-3` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `204-222-03`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('20422203.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Net Assessed Total Value** | $4,360.00 |
...
- **Owner of Record**: **MAHECHA MARIA CAMILA ORREGO**
...
- **Last Recorded Doc Number**: `226057853` (Recorded: 05/21/2026)
