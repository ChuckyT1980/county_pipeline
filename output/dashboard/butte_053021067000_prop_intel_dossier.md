# Pre-Auction Property Intelligence Dossier: 053-021-067-000

**County**: Butte County, CA  
**Source Identifier**: `053-021-067-000` (APN (from source list))  
**Assessor APN**: `053-021-067-000`  
...
| **Estimated Equity Ratio** | **37.3%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $6,133.00 |
| **Net Assessed Total Value** | $9,784.00 |
...
- **Owner of Record**: **MATSON MARIE C**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 6232  LUCKY JOHN RD  PARADISE
