# Pre-Auction Property Intelligence Dossier: 054-161-037-000

**County**: Butte County, CA  
**Source Identifier**: `054-161-037-000` (APN (from source list))  
**Assessor APN**: `054-161-037-000`  
...
| **Estimated Equity Ratio** | **54.5%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $9,107.00 |
| **Net Assessed Total Value** | $20,000.00 |
...
- **Owner of Record**: **MALLOY KRISTY**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: Yes
- **Property Situs Address**: 5651  STAPLETON LN  PARADISE
...
- **Open Encumbrance Count**: 15 recorded instruments
