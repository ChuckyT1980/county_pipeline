# Pre-Auction Property Intelligence Dossier: 062-190-025-000

**County**: Butte County, CA  
**Source Identifier**: `062-190-025-000` (APN (from source list))  
**Assessor APN**: `062-190-025-000`  
...
| **Estimated Equity Ratio** | **29.0%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $7,418.00 |
| **Net Assessed Total Value** | $10,444.00 |
...
- **Owner of Record**: **BLACK DAVID W**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 0  FIR PATH   BERRY CREEK
