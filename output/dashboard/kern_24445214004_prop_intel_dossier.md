# Pre-Auction Property Intelligence Dossier: 244-452-14-00-4

**County**: Kern County, CA  
**Source Identifier**: `244-452-14-00-4` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `244-452-14`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('24445214.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Estimated Equity Ratio** | **57.7%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $800.00 |
| **Net Assessed Total Value** | $1,890.00 |
...
- **Owner of Record**: **EDWARDS SANBORN LAND HOLDINGS LLC**
...
- **Last Recorded Doc Number**: `226057829` (Recorded: 05/21/2026)
