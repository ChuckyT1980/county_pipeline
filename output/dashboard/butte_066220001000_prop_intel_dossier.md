# Pre-Auction Property Intelligence Dossier: 066-220-001-000

**County**: Butte County, CA  
**Source Identifier**: `066-220-001-000` (APN (from source list))  
**Assessor APN**: `066-220-001-000`  
...
| **Estimated Equity Ratio** | **37.9%** |
| **Equity / Assessed-Value Indicator** | **MEDIUM** |
| **Minimum Starting Bid** | $7,448.00 |
| **Net Assessed Total Value** | $12,000.00 |
...
- **Owner of Record**: **TINDALL BRAIN JEFFERY**
- **Owner Entity Type**: Individual
- **Out-of-State Owner**: No
- **Property Situs Address**: 13607 S PARK DR  MAGALIA
