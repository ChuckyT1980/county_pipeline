# Pre-Auction Property Intelligence Dossier: 082-042-33-00-0

**County**: Kern County, CA  
**Source Identifier**: `082-042-33-00-0` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `082-042-33`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('8204233.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Estimated Equity Ratio** | **90.8%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $9,800.00 |
| **Net Assessed Total Value** | $106,948.00 |
...
- **Property Situs Address**: 74 SIERRA DR KERNVILLE
