# Pre-Auction Property Intelligence Dossier: 212-042-01-00-4

**County**: Kern County, CA  
**Source Identifier**: `212-042-01-00-4` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `212-042-01`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('21204201.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Estimated Equity Ratio** | **8.6%** |
| **Equity / Assessed-Value Indicator** | **LOW** |
| **Minimum Starting Bid** | $4,700.00 |
| **Net Assessed Total Value** | $5,141.00 |
...
- **Owner of Record**: **GB REALTY GRP LLC**
...
- **Last Recorded Doc Number**: `226054298` (Recorded: 05/13/2026)
...
- **Primary Source Endpoint**: `assessorapps.kerncounty.com (live, verified 2026-08-06/07) + recorderonline.co.kern.ca.us document-number search (live, verified 2026-08-08, doc #226054298)`
- **Data Integrity Status**: VERIFIED — BOTH SITES (assessed value/tax-default status and recorder document/owner only - the assessor parcel number itself is NOT independently verified, see Assessor APN Verification Status above). Assessed value and tax-default status confirmed live against the county assessor. Owner of record confirmed via the recorder's document-number search on the exact recorded document (Deed - Quitclaim, 05/13/2026) already captured for this specific parcel — tied to this parcel's ATN-identified record, not a name-only match. NOTE: this corrects a stale name from the original source list ("PELETI TUI & VERA 2007 TRUST") — the property has a more recent recorded transfer to "GB REALTY GRP LLC" that the source list predates.
