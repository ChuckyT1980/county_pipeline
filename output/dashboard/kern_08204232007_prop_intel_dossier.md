# Pre-Auction Property Intelligence Dossier: 082-042-32-00-7

**County**: Kern County, CA  
**Source Identifier**: `082-042-32-00-7` (ATN (Assessment/Tax Number, Kern tax-roll identifier))  
**Assessor APN**: `082-042-32`  
**Assessor APN Verification Status**: NOT_VERIFIED — derived from the ATN's own structure (first 3 segments) and cross-checked against the source list's separate APN_1 column ('8204232.0', digits match); NOT independently confirmed by reading the assessor's own displayed APN field this run  
...
| **Estimated Equity Ratio** | **90.9%** |
| **Equity / Assessed-Value Indicator** | **HIGH** |
| **Minimum Starting Bid** | $16,500.00 |
| **Net Assessed Total Value** | $182,048.00 |
...
- **Property Situs Address**: 84 SIERRA DR KERNVILLE
